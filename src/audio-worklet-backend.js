 ...
 */
export default function createAudioWorklet(context, nChannels, bufferLength, bufferThreshold, pathToWorklet) {
	...
	return new Promise((resolve, reject) => {
		context.audioWorklet.addModule(pathToWorklet)
			.then(() => {
				...
				let backend = new AudioWorkletBackend(nChannels, bufferLength, workletNode);
				resolve(backend);
			});
	});
}
